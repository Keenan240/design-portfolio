...
const cardData = [
  {
    ...
    description: 'Extract due dates and structure from syllabi automatically.'
  },
  {
    color: '#060010',
    label: 'Planning',
    title: 'Weekly View',
    description: 'See your week at a glance with color-coded tasks.'
  },
  {
    color: '#060010',
    label: 'Courses',
    title: 'Classes Page',
    description: 'One place for each course\'s info and deadlines.'
  },
  {
    color: '#060010',
    label: 'Milestones',
    title: 'Subdeadlines',
    description: 'Break large assignments into manageable steps.'
  },
  {
    color: '#060010',
    label: 'Sync',
    title: 'D2L Integration',
    description: 'Connect with your institution\'s learning management system.'
  },
  {
    color: '#060010',
    label: 'Grades',
    title: 'Grade Calculator',
    description: 'Project your grade based on weights and scores.'
  }
];
